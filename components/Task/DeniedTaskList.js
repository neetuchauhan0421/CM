...
class DeniedTaskList extends Component {
     constructor(props) {
          super(props)
          this.state = {
               persons: [],
     ...
     _getData = () => {
          ...
          axios.get(serverURI + '/getTaskDeniedList/' + this.props.userLogged)
               .then(response => {
...
export default connect(mapStateToProps)(DeniedTaskList);
