...
class ContactAccepted extends Component {
     constructor(props) {
          super(props)
          this.state = {
               persons: [],
     ...
     _getData = () => {
          ...
          axios.get(serverURI + '/getContactAcceptedList/' + this.props.userLogged)
               .then(response => {
...
export default connect(mapStateToProps)(ContactAccepted);
