...
class DeniedMeetings extends Component {
     constructor(props) {
          super(props)
          this.state = {
               persons: [],
     ...
     _getData = () => {
          ...
          axios.get(serverURI + '/getMeetingDeniedList/' + this.props.userLogged)
               .then(response => {
...
export default connect(mapStateToProps)(DeniedMeetings);
